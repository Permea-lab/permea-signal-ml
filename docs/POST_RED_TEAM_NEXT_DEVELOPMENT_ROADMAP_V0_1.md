...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A — Preprint-readiness hardening | P1/P2 | Public submission requires metadata, references, supplement, and export closure. | Task 047, then citation insertion task | No | Yes | Partly | Verified reference packs exist, but bibliography and manuscript citation insertion are still pending. |
