# Internal/Friendly Review Snapshot Note

This is an internal/friendly review paper snapshot derived from `docs/paper/permea-first-paper-manuscript-v0-2.md`. It is not a public preprint, not a submission-ready bioRxiv package, and not evidence of external expert review or peer review.

Public bioRxiv remains **Hold / not submission-ready**. Dataset redistribution remains unresolved. Supplement/export remains incomplete.
...
This manuscript draft is an internal first-paper v0.2 assembly from existing materials. It does not declare public bioRxiv readiness and does not imply external expert review or peer review.
