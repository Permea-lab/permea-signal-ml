...
- paper package planning document
- preprint skeleton
- preprint draft
- preprint assembly document
- supplementary outline
- bioRxiv submission checklist

## What is still unresolved

- final authorship and affiliations are not yet set
...
1. Finalize metadata placeholders when authorship details are ready.
2. Decide what belongs in the supplement versus the main text.
3. Perform one last editorial and formatting pass across the manuscript package.
4. Prepare an export-friendly manuscript and asset set.
5. Move to bioRxiv submission after the remaining blockers are cleared.
